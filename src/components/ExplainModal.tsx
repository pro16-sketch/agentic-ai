...
export const ExplainModal: React.FC<ExplainModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-fadeIn">
      <div 
        className="relative w-full max-w-3xl bg-slate-900 border border-slate-700/80 rounded-2xl shadow-2xl overflow-hidden"
      ...
      >
        ...
        <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
          ...
          <div className="bg-blue-950/30 border border-blue-800/40 rounded-xl p-4 text-slate-200 text-sm leading-relaxed">
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-xs text-slate-300">
                <strong className="text-white">Human-in-the-Loop Safety:</strong> The AI never takes drastic business actions without executive authorization.
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            {onStartWalkthrough && (
              <button
                ...
                className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold px-4 py-2 rounded-xl transition-all shadow-md shadow-blue-600/20"
              >
