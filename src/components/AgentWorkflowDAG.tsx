        ...
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            <h3 className="text-sm font-bold text-white flex items-center space-x-2">
              ...
              <span className="text-[10px] font-mono text-indigo-300 bg-indigo-950/80 border border-indigo-700/60 px-2 py-0.5 rounded-full">
          ...
          return (
            <button
              ...
              className={`text-left p-3 rounded-xl border transition-all flex flex-col justify-between ${
                isSelected
                  ? 'bg-blue-950/50 border-blue-500/80 shadow-md shadow-blue-500/10 ring-1 ring-blue-500/50'
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className={`text-[9px] font-mono px-1.5 py-0.5 rounded border ${node.badgeColor}`}>
                  {node.status}
                </span>
              </div>
      ...
      <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
          <div className="flex items-center space-x-2">
            <span className="text-xs font-mono text-blue-400 font-bold">{currentNode.stage}</span>
